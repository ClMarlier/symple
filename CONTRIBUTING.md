...
2. Download the sources and switch the working directory:
    ...
    ```bash
    go get -u -d github.com/ClMarlier/symple
    cd $GOPATH/src/github.com/ClMarlier/symple
    ```
...
6. Run `make check`, If any, fix issue and return to step 4.
7. Run `make cover`, If not 100% cover, return to the step 3.
